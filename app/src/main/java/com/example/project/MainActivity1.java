...
public class MainActivity1 extends AppCompatActivity {
    ...
    private Button picture,predict,first;
    private TextView tv;
...
//                        tv.setText(indexToWords.get("2341"));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1=new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener()
                //first.setOnClickListener(new TextToSpeech.OnClickListener()
        {
            @Override
...
//                intent.setType("image/*");
                    ...
                    Toast.makeText(MainActivity1.this, "OpenCV Loaded Successfully!", Toast.LENGTH_SHORT).show();
                } else {
//                    Intent intent=new Intent(Intent.ACTION_GET_CONTENT);
                    Intent camera  = new Intent(android.provider.MediaStore.ACTION_IMAGE_CAPTURE);
//                intent.setType("image/*");
                    ...
                    Toast.makeText(MainActivity1.this, "OpenCV Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ////////////////////////////////////////////////OCR/////////////////////////////////////////////////////
        ocr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //tv1.setText(R.string.error_prompt);
                //} else {
                ...
                // }
                //}
                //tv1.setText(strBuilder.toString().substring(0, strBuilder.toString().length() - 1));
                //}
                //////////////////////////////////////////méthode2///////////////////////////////////////////
                //TextRecognizer textRecognizer = new TextRecognizer.Builder(getApplicationContext()).build();
                //if (!textRecognizer.isOperational()) {
                //tv.setText(R.string.error_prompt);
                //} else {
                //Frame imageFrame = new Frame.Builder().setBitmap(img).build();
                //String imageText = "";
                    //SparseArray fait correspondre des entiers à des objets , plus efficace par rapport a hashmap
                ...
                //}
                    //return imageText;
                //tv.setText(imageText.toString().substring(0, imageText.toString().length() - 1));
                //}
                }
        });
        ////////////////////////////////////////////////caption image/////////////////////////////////////////////////////
...
//                        tv.setText(indexToWords.get("2341"));
                ...
                translateAPI.setTranslateListener(new TranslateAPI.TranslateListener() {
                    ...
                    public void onSuccess(String translatedText) {
                        Log.d(TAG, "onSuccess: "+translatedText);
                        tv.setText(translatedText);
                        t1.speak(translatedText.toString(), TextToSpeech.QUEUE_FLUSH, null);
                    }
                    @Override
                    public void onFailure(String ErrorText) {
                        Log.d(TAG, "onFailure: "+ErrorText);
