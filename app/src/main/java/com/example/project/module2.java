...
public class module2 extends AppCompatActivity {
    ...
    private void ChangeLanguageDialog(){
        // https://github.com/nisaefendioglu/Translate/tree/master
        //  Google Mlkit
        final String[] listItems = {"French","Spanish","Italian","Arabic","Hindi"};
        AlertDialog.Builder builder = new AlertDialog.Builder(module2.this);
        ...
        builder.setSingleChoiceItems(listItems, -1, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int k) {
                ...
                if (k == 0) {
                    String LanguageOneTAG = "en"; // Code de langue pour l'anglais
                    String LanguageTwoTAG = "fr"; // Code de langue pour le français
                    ...
                    // Vérifiez si le modèle est téléchargé, sinon téléchargez-le
                    translator.downloadModelIfNeeded()
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void v) {
                                    // Le modèle est téléchargé avec succès, vous pouvez maintenant traduire le texte
                                    translator.translate(text)
                                            .addOnSuccessListener(
                                                    new OnSuccessListener<String>() {
                                                        @Override
                                                        public void onSuccess(@NonNull String translatedText) {
                                                            // La traduction réussie se trouve dans translatedText
                                                            Log.e(TAG, "Traduction réussie : " + translatedText);
                                                            // Faites ce que vous voulez avec le texte traduit ici
                                            ...
                                            .addOnFailureListener(new OnFailureListener() {
                                                ...
                                                public void onFailure(@NonNull Exception e) {
                                                    // Gérer les erreurs de traduction ici
                                                    Log.e(TAG, "Erreur lors de la traduction : " + e.getMessage());
                                                    tv1.setText("Erreur lors de la traduction ");
                                                }
                                            });
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    // Gérer les erreurs de téléchargement du modèle ici
                                    Log.e(TAG, "Erreur lors du téléchargement du modèle : " + e.getMessage());
                                }
                            });
                }
                if (k == 1) {
                    String LanguageOneTAG = "en"; // Code de langue pour l'anglais
                    String LanguageTwoTAG = "es"; // Code de langue pour le français
                    // Configuration du traducteur
                    TranslatorOptions options = new TranslatorOptions.Builder()
                            .setSourceLanguage(LanguageOneTAG)
                            .setTargetLanguage(LanguageTwoTAG)
                ...
                if (k == 2) {
                    String LanguageOneTAG = "en"; // Code de langue pour l'anglais
                    String LanguageTwoTAG = "it"; // Code de langue pour italie
                    // Configuration du traducteur
                    TranslatorOptions options = new TranslatorOptions.Builder()
                            .setSourceLanguage(LanguageOneTAG)
                            .setTargetLanguage(LanguageTwoTAG)
                ...
                if (k == 3) {
                    String LanguageOneTAG = "en"; // Code de langue pour l'anglais
                    String LanguageTwoTAG = "ar"; // Code de langue pour arabe
                    // Configuration du traducteur
                    TranslatorOptions options = new TranslatorOptions.Builder()
                            .setSourceLanguage(LanguageOneTAG)
                            .setTargetLanguage(LanguageTwoTAG)
                ...
                if (k == 4) {
                    String LanguageOneTAG = "en"; // Code de langue pour l'anglais
                    String LanguageTwoTAG = "hi"; // Code de langue pour hindi
                    // Configuration du traducteur
                    TranslatorOptions options = new TranslatorOptions.Builder()
                            .setSourceLanguage(LanguageOneTAG)
                            .setTargetLanguage(LanguageTwoTAG)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GENERATE_CAPTION.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog = ProgressDialog.show(module2.this, "I am captioning...", "please wait..", true);
...
//                intent.setType("image/*");
                    ...
                    Toast.makeText(module2.this, "OpenCV Loaded Successfully!", Toast.LENGTH_SHORT).show();
                }else {
//                    Intent intent=new Intent(Intent.ACTION_GET_CONTENT);
                    Intent camera  = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
//                intent.setType("image/*");
                    ...
                    Toast.makeText(module2.this, "OpenCV Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ////////////////////////////////////////////////prend image/////////////////////////////////////////////////////
        GENERATE_CAPTION1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(module2.this, "Select Picture", Toast.LENGTH_SHORT).show();
            }
        });
        ////////////////////////////////////////////////OCR/////////////////////////////////////////////////////
