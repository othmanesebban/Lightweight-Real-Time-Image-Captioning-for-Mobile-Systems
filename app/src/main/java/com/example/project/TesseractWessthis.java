...
/*   Inception-v3 */
public class TesseractWessthis extends AppCompatActivity {
    static {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GENERATE_CAPTION.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog = ProgressDialog.show(TesseractWessthis.this, "I am captioning...", "please wait..", true);
...
//                intent.setType("image/*");
                    ...
                    Toast.makeText(TesseractWessthis.this, "OpenCV Loaded Successfully!", Toast.LENGTH_SHORT).show();
                }else {
//                    Intent intent=new Intent(Intent.ACTION_GET_CONTENT);
                    Intent camera  = new Intent(android.provider.MediaStore.ACTION_IMAGE_CAPTURE);
//                intent.setType("image/*");
                    ...
                    Toast.makeText(TesseractWessthis.this, "OpenCV Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ////////////////////////////////////////////////prend image/////////////////////////////////////////////////////
        GENERATE_CAPTION1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(TesseractWessthis.this, "Select Picture", Toast.LENGTH_SHORT).show();
            }
        });
        ////////////////////////////////////////////////OCR/////////////////////////////////////////////////////
