...
public class InceptionV4 extends AppCompatActivity {
    static {
    ...
    private static final String MODEL_FILE = "file:///android_asset/inceptionV4/merged_frozen_graph.pb";
    private static final String INPUT1 = "encoder/import/InputImage:0";
    private static final String OUTPUT_NODES = "inceptionV4/DecoderOutputs_LSTM.txt";
    private TensorFlowInferenceInterface InferenceInterface;
    ...
    public void AppelDetecetionText() {
        ...
        String DATA_PATH = getFilesDir() + "/tessdata/";
        Log.d("Data Path", DATA_PATH); // Ajoutez cette ligne
        String lang = "eng"; // Langue à utiliser (par exemple, anglais)
        baseApi.init(DATA_PATH, lang);
        // Supposons que vous avez une image bitmap appelée "myBitmap"
        baseApi.setImage(img);
        String recognizedText = baseApi.getUTF8Text();
        tv2.setText(recognizedText);
        baseApi.end();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GENERATE_CAPTION.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog = ProgressDialog.show(InceptionV4.this, "I am captioning...", "please wait..", true);
...
//                intent.setType("image/*");
                    ...
                    Toast.makeText(InceptionV4.this, "OpenCV Loaded Successfully!", Toast.LENGTH_SHORT).show();
                }else {
//                    Intent intent=new Intent(Intent.ACTION_GET_CONTENT);
                    Intent camera  = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
//                intent.setType("image/*");
                    ...
                    Toast.makeText(InceptionV4.this, "OpenCV Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ////////////////////////////////////////////////prend image/////////////////////////////////////////////////////
        GENERATE_CAPTION1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(InceptionV4.this, "Select Picture", Toast.LENGTH_SHORT).show();
            }
        });
        ////////////////////////////////////////////////OCR/////////////////////////////////////////////////////
