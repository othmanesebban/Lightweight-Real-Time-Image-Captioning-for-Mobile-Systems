...
public class module4 extends AppCompatActivity {
    ...
    private void ChangeLanguageDialog(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(module4 .this);
...
//                        tv.setText(indexToWords.get("2341"));
                ...
                if (k == 0) {
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
                            Translate translate = TranslateOptions.newBuilder().setApiKey("your_api_key_here").build().getService();
...
//                        tv.setText(indexToWords.get("2341"));
    ...
    ////////////////////////////////////////////////////////la méthode OCR/////////////////////////////////////////////
    // TessTwo-Android
    //https://github.com/ojhariddhish/TesseractOCRDemo/blob/master/app/src/main/java/com/dnsoftindia/tesseractocrdemo/MainActivity.java
    public void AppelDetecetionText() {
        mTess.setImage(img);
        String OCRresult;
        OCRresult = mTess.getUTF8Text();
        if (OCRresult != null && !OCRresult.trim().isEmpty()) {
            // Le texte a été détecté dans l'image
            Toast.makeText(getBaseContext(), OCRresult, Toast.LENGTH_SHORT).show();
            tv2.setText(OCRresult);
        } else {
            // Aucun texte détecté dans l'image
            Toast.makeText(getBaseContext(), "No Text Detected", Toast.LENGTH_LONG).show();
            tv2.setText("No Text Detected");
        }

    }
    private String getLanguageDataFilePath(String language) {
        return datapath + "/tessdata/" + language + ".traineddata";
    }
    private void checkFile(File dir, String language) {
        // Répertoire inexistant, mais nous pouvons le créer avec succès
        if (!dir.exists() && dir.mkdirs()) {
            copyFiles();
        }
        // Le répertoire existe, mais il n'y a pas de fichier de données à l'intérieur
        if (dir.exists()) {
            String datafilepath = getLanguageDataFilePath(language);
    ...
    private void copyFiles() {
        try {
            String[] languages = {"eng", "ita", "fra"}; // Liste des langues à copier
            for (String language : languages) {
                // Emplacement du fichier traineddata pour la langue actuelle
                String filepath = datapath + "/tessdata/" + language + ".traineddata";
                // Obtenir l'accès à AssetManager
                AssetManager assetManager = getAssets();
                // Ouvrir les flux d'octets pour la lecture/écriture
                InputStream instream = assetManager.open("tessdata/" + language + ".traineddata");
                OutputStream outstream = new FileOutputStream(filepath);
                // Copier le fichier vers l'emplacement spécifié par filepath
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] languages = {"eng", "fr", "ita"}; // Liste des langues
        for (String language : languages) {
            checkFile(new File(datapath + "tessdata/"), language);
        }
        // Ensuite, vous pouvez initialiser Tesseract avec la dernière langue de la liste
        mTess.init(datapath, languages[languages.length - 1]);
        ...
        GENERATE_CAPTION.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog = ProgressDialog.show(module4 .this, "I am captioning...", "please wait..", true);
...
//                intent.setType("image/*");
                    ...
                    Toast.makeText(module4 .this, "OpenCV Loaded Successfully!", Toast.LENGTH_SHORT).show();
                }else {
//                    Intent intent=new Intent(Intent.ACTION_GET_CONTENT);
                    Intent camera  = new Intent(android.provider.MediaStore.ACTION_IMAGE_CAPTURE);
//                intent.setType("image/*");
                    ...
                    Toast.makeText(module4 .this, "OpenCV Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ////////////////////////////////////////////////prend image/////////////////////////////////////////////////////
        GENERATE_CAPTION1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(module4 .this, "Select Picture", Toast.LENGTH_SHORT).show();
            }
        });
        ////////////////////////////////////////////////OCR/////////////////////////////////////////////////////
