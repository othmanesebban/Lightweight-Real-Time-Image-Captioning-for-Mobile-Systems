...
public class InceptionV3 extends AppCompatActivity {
    static {
    ...
    String language = "ita_old+fra+eng+ita";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GENERATE_CAPTION.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog = ProgressDialog.show(InceptionV3.this, "I am captioning...", "please wait..", true);
...
//                intent.setType("image/*");
                    ...
                    Toast.makeText(InceptionV3.this, "OpenCV Loaded Successfully!", Toast.LENGTH_SHORT).show();
                }else {
//                    Intent intent=new Intent(Intent.ACTION_GET_CONTENT);
                    Intent camera  = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
//                intent.setType("image/*");
                    ...
                    Toast.makeText(InceptionV3.this, "OpenCV Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ////////////////////////////////////////////////prend image/////////////////////////////////////////////////////
        GENERATE_CAPTION1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(InceptionV3.this, "Select Picture", Toast.LENGTH_SHORT).show();
            }
        });
        ////////////////////////////////////////////////OCR/////////////////////////////////////////////////////
