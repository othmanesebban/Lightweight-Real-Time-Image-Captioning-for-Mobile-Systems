...
public class MobileNetV2 extends AppCompatActivity {
    static {
    ...
    private static final String MODEL_FILE = "file:///android_asset/mobileNetV2/MobileNet-V2_graph.pb";
    private static final String INPUT1 = "encoder/import/input_1:0";
    private static final String OUTPUT_NODES = "mobileNetV2/DecoderOutputs_LSTM.txt";
    private TensorFlowInferenceInterface InferenceInterface;
    ...
    private void ChangeLanguageDialog(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(MobileNetV2.this);
    ...
    public void AppelDetecetionText() {
        ...
        if (!recognizer.isOperational()) {
            Toast.makeText(MobileNetV2.this, "Error", Toast.LENGTH_SHORT).show();
        } else {
            Frame frame = new Frame.Builder().setBitmap(img).build();
            SparseArray<TextBlock> items = recognizer.detect(frame);
            if (items.size() == 0) {
                Toast.makeText(MobileNetV2.this, "No Text Detected", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GENERATE_CAPTION.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog = ProgressDialog.show(MobileNetV2.this, "I am captioning...", "please wait..", true);
...
//                intent.setType("image/*");
                    ...
                    Toast.makeText(MobileNetV2.this, "OpenCV Loaded Successfully!", Toast.LENGTH_SHORT).show();
                }else {
//                    Intent intent=new Intent(Intent.ACTION_GET_CONTENT);
                    Intent camera  = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
//                intent.setType("image/*");
                    ...
                    Toast.makeText(MobileNetV2.this, "OpenCV Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ////////////////////////////////////////////////prend image/////////////////////////////////////////////////////
        GENERATE_CAPTION1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MobileNetV2.this, "Select Picture", Toast.LENGTH_SHORT).show();
            }
        });
        ////////////////////////////////////////////////OCR/////////////////////////////////////////////////////
